  ...
  const [rows] = await conn.query(
    `
      SELECT
        ...
        fr.currency_id,
        fr.exchange_rate,
        fr.exchange_rate_date,
        fr.exchange_rate_type,
        fr.exchange_rate_source,
        fr.vendor_id,
...
async function insertFrpHeader(conn, data) {
  await conn.query(
    ...
    [
      ...
      data.frp_number,
      data.status,
      data.source_module || 'DIRECT',
      data.source_rp_request_id || null,
      data.source_rp_number || null,
      ...
      data.exchange_rate_type || null,
      data.exchange_rate_source || null,
...
async function insertFrpItem(conn, data) {
  await conn.query(
    ...
    [
      data.id,
      data.frp_request_id,
      data.source_rp_request_item_id || null,
      data.is_amount_overridden || 0,
      data.original_rp_amount || null,
      data.budget_id,
