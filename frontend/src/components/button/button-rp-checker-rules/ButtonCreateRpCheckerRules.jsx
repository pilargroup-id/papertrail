...
import DialogCreateRpCheckerRules from '../../Dialog/dialog-rp-checker-rules/DialogCreateRpCheckerRules.jsx'
...
function ButtonCreateRpCheckerRules({
  children = 'Create RP Checker Rule',
  className = '',
  variant = 'accordion',
  tone = 'default',
  active = false,
...
export default ButtonCreateRpCheckerRules
