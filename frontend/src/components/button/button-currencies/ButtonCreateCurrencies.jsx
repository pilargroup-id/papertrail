...
import DialogCreateCurrencies from '../../Dialog/dialog-currencies/DialogCreateCurrencies.jsx'
...
function ButtonCreateCurrencies({
  children = 'Create Currencies',
  className = '',
  variant = 'accordion',
  tone = 'default',
  active = false,
...
export default ButtonCreateCurrencies