...
import DialogCreatePaymentMethods from '../../Dialog/dialog-payment-methods/DialogCreatePaymentMethods.jsx'
...
function ButtonCreatePaymentMethods({
...
export default ButtonCreatePaymentMethods
