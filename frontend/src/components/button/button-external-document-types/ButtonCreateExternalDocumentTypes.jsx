...
import DialogCreateExternalDocumentsType from '../../Dialog/dialog-external-document-types/DialogCreateExternalDocumentsType'
...
function ButtonCreateExternalDocumentsType({
  ...
  return (
    <>
      ...
      <DialogCreateExternalDocumentsType
        {...dialogProps}
        isOpen={isDialogOpen}
...
export default ButtonCreateExternalDocumentsType
