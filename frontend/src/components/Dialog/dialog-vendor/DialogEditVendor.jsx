...
function DialogEditVendor({
  ...
  const handleSubmit = async (event) => {
    ...
    if (vendorId === undefined || vendorId === null) {
      setSubmitError('Data vendor tidak ditemukan.')
      return
    }
    ...
    try {
      const response = await api.vendors.update(vendorId, {
        name: normalizedName,
      })
      ...
      setSubmitError(error.message || 'Gagal memperbarui vendor.')
    } finally {
      setIsSubmitting(false)
    }
  }
        ...
        <form onSubmit={handleSubmit}>
          <div className="dashboard-popup__header">
            <div>
              ...
              <h2 className="dashboard-popup__title" id="dialog-edit-vendor-title">
                {title}
              </h2>
            </div>
...
export default DialogEditVendor
