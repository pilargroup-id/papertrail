...
function DialogCreateExternalDocumentsType({
  isOpen = false,
  eyebrow = 'External Document Types',
  title = 'Create External Document Type',
  onClose,
  onCreated,
}) {
  ...
  const handleSubmit = async (event) => {
    ...
    if (!normalizedName) {
      nextFieldErrors.name = 'Name external document type wajib diisi.'
    }
    ...
    try {
      const response = await api.externalDocumentTypes.create({
        code: normalizedCode,
        name: normalizedName,
      ...
      setSubmitError(error.message || 'Gagal membuat external document type.')
    } finally {
      setIsSubmitting(false)
    }
  }
  ...
  const dialogNode = (
    <div className="dashboard-popup-overlay" role="presentation" onClick={onClose}>
      <div
        ...
        role="dialog"
        aria-modal="true"
        aria-labelledby="dialog-create-external-document-type-title"
        ...
        <form onSubmit={handleSubmit}>
          <div className="dashboard-popup__header">
            <div>
              ...
              <h2 className="dashboard-popup__title" id="dialog-create-external-document-type-title">
                {title}
              </h2>
            </div>
          </div>
...
export default DialogCreateExternalDocumentsType
