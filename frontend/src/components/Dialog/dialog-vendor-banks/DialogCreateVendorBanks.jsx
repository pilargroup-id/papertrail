...
function DialogCreateVendorBanks({
  isOpen = false,
  eyebrow = 'Vendor Banks',
  title = 'Create Vendor Banks Account',
  onClose,
  onCreated,
}) {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      const response = await api.vendorBankAccounts.create({
      ...
      setSubmitError(error.message || 'Gagal membuat vendor bank account.')
    } finally {
      setIsSubmitting(false)
    }
  }
  ...
  const dialogNode = (
    <div className="dashboard-popup-overlay" role="presentation" onClick={onClose}>
      <div
        ...
        role="dialog"
        aria-modal="true"
        aria-labelledby="dialog-create-vendor-banks-title"
        ...
        <form onSubmit={handleSubmit}>
          <div className="dashboard-popup__header">
            <div>
              ...
              <h2 className="dashboard-popup__title" id="dialog-create-vendor-banks-title">
                {title}
              </h2>
            </div>
          </div>
...
export default DialogCreateVendorBanks
