...
function DialogCreateFrpDocumentsType({
  isOpen = false,
  eyebrow = 'FRP Document Types',
  title = 'Create FRP Document Type',
  onClose,
  onCreated,
}) {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      const response = await api.frpDocumentTypes.create({
        code: normalizedCode,
        name: normalizedName,
      ...
      setSubmitError(error.message || 'Gagal membuat FRP document type.')
    } finally {
      setIsSubmitting(false)
    }
  }
  ...
  const dialogNode = (
    <div className="dashboard-popup-overlay" role="presentation" onClick={onClose}>
      <div
        ...
        role="dialog"
        aria-modal="true"
        aria-labelledby="dialog-create-frp-document-type-title"
        ...
        <form onSubmit={handleSubmit}>
          <div className="dashboard-popup__header">
            <div>
              ...
              <h2 className="dashboard-popup__title" id="dialog-create-frp-document-type-title">
                {title}
              </h2>
            </div>
          </div>
...
export default DialogCreateFrpDocumentsType
