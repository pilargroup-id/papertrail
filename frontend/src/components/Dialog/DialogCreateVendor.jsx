...
import ButtonCreateBudgets from '../button/ButtonCreateBudgets.jsx'
  ...
  const dialogNode = (
    <div className="dashboard-popup-overlay" role="presentation" onClick={onClose}>
      <div
        ...
        style={{ width: 'min(92vw, 920px)', maxWidth: 'none', maxHeight: '95vh', display: 'flex', flexDirection: 'column' }}
      >
