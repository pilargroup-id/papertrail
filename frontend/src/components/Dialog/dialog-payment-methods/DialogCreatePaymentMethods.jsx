...
function DialogCreatePaymentMethods({
  isOpen = false,
  ...
  const handleSubmit = async (event) => {
    ...
    if (!normalizedName) {
      nextFieldErrors.name = 'Name payment method wajib diisi.'
    }
    ...
    try {
      ...
      setSubmitError(error.message || 'Gagal membuat payment method.')
    } finally {
      setIsSubmitting(false)
    }
  }
  ...
  const dialogNode = (
    <div className="dashboard-popup-overlay" role="presentation" onClick={onClose}>
      <div
        ...
        role="dialog"
        aria-modal="true"
        aria-labelledby="dialog-create-payment-method-title"
        ...
        <form onSubmit={handleSubmit}>
          <div className="dashboard-popup__header">
            <div>
              ...
              <h2 className="dashboard-popup__title" id="dialog-create-payment-method-title">
                {title}
              </h2>
            </div>
          </div>
                  ...
                  <div className="register-user-popup__grid register-user-popup__grid--vendor-banks">
                    <div className="register-user-popup__field">
                      <TextField
                        ...
                        placeholder="Input code payment method"
                        leftIcon={Code}
                        required
                    ...
                    <div className="register-user-popup__field">
                      <TextField
                        ...
                        placeholder="Input name payment method"
                        leftIcon={FileText01}
                        required
                        disabled={isFormDisabled}
...
export default DialogCreatePaymentMethods
