...
import { logsMobileStatusTabs } from '../../mobile/mobile-button/logs/MobileTabsLogs.jsx'
...
function TabsLogsDekstop({
  activeStatus = logsMobileStatusTabs[0].id,
...
export default TabsLogsDekstop
