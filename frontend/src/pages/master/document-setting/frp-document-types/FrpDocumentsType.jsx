...
import DialogEditFrpDocumentsType from '../../../../components/Dialog/dialog-frp-documents-type/DialogEditFrpDocumentsType.jsx'

import ButtonCreateFrpDocumentsType from '../../../../components/button/button-frp-documents-type/ButtonCreateFrpDocumentsType.jsx'
...
function FrpDocumentsTypePage(props) {
  ...
  useEffect(() => {
    ...
    async function loadFrpDocumentsTypeRules() {
      ...
      try {
        const response = await api.frpDocumentTypes.list(
          {
            page: 1,
            limit: 100,
            q: searchQuery,
  ...
  const handleRuleStatusChange = async (budgetAccessRule, nextIsActive) => {
    ...
    try {
      const response = await api.frpDocumentTypes.updateStatus(budgetAccessRuleId, normalizedIsActive)
      const updatedRule = getRuleFromResponse(response)
